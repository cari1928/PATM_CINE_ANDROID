...
public class ProveedorDeContenido extends ContentProvider {
    ...
    private static final int ROL_ALL_REGS = 2;
    ...
    static {
        ...
        sMimeTypes.put(
                ...
                "vnd.android.cursor.dir/vnd." +
                        Contrato.AUTHORITY + "." + ROL_TABLE_NAME);
        sMimeTypes.put(
                ROL_ONE_REG,
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        void inicializarDatos(SQLiteDatabase db) {
            db.execSQL("INSERT INTO " + ROL_TABLE_NAME + " (" + Contrato.Rol._ID + "," + Contrato.Rol.ROL + ") " +
